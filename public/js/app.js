...
/* harmony import */ var _vuex_helpers__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./vuex/helpers */ "./resources/js/vuex/helpers.js");
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    register: function register() {
      ...
      this.$store.dispatch("register", credentials).then(function () {
        _this.$router.push({
          name: "dashboard"
        });
      })["catch"](function (err) {
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    getUsers: function getUsers() {
      ...
      axios__WEBPACK_IMPORTED_MODULE_0___default.a.get("http://127.0.0.1:8000/api/" + "users").then(function (returnedData) {
        _this.users = returnedData.data.users;
      })["catch"](function (err) {
        console.error(err);
      });
    }
  },
  beforeCreate: function beforeCreate() {// Vue.redirectIfNotAuthenticated();
  },
              ...
              _c("ul", { staticClass: "navbar-nav" }, [
                _c(
                  ...
                  [
                    _c(
                      "router-link",
                      { class: "nav-link", attrs: { to: { name: "home" } } },
                      [_vm._v("Home")]
                    )
                  ],
                  1
...
var render = function() {
  ...
  return _c("div", [
    ...
    _vm._v(" "),
    _vm.loggedIn
      ? _c("button", { class: "btn btn-primary", on: { click: _vm.logout } }, [
          _vm._v("\n        Logout\n    ")
        ])
      : _vm._e()
  ])
...
var render = function() {
  ...
  return _c(
    "div",
    [
      _c("h1", [_vm._v("Laravel 6 Passport Vue.js Auth")]),
      _vm._v(" "),
      !_vm.loggedIn
        ? _c(
            "router-link",
...
/* harmony import */ var _vuex_store__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./vuex/store */ "./resources/js/vuex/store.js");
...
new vue__WEBPACK_IMPORTED_MODULE_0___default.a({
  store: _vuex_store__WEBPACK_IMPORTED_MODULE_4__["default"],
  router: _router_router__WEBPACK_IMPORTED_MODULE_1__["default"],
  beforeCreate: function beforeCreate() {
    var accessToken = js_cookie__WEBPACK_IMPORTED_MODULE_3__["get"]("accessToken");

    if (accessToken) {
      axios__WEBPACK_IMPORTED_MODULE_2___default.a.defaults.headers.common.Authorization = "Bearer " + accessToken;
    }
  },
  created: function created() {
    var accessToken = js_cookie__WEBPACK_IMPORTED_MODULE_3__["get"]("accessToken");
    ...
    if (accessToken) {
      _vuex_store__WEBPACK_IMPORTED_MODULE_4__["default"].dispatch("refresh");
    }
  },
  render: function render(h) {
...
var isLoggedIn = function isLoggedIn(to, from, next) {
  var accessToken = typeof js_cookie__WEBPACK_IMPORTED_MODULE_2__["get"]("accessToken") != "undefined" ? js_cookie__WEBPACK_IMPORTED_MODULE_2__["get"]("accessToken") : false;
...
var router = new vue_router__WEBPACK_IMPORTED_MODULE_1__["default"](options);
/* harmony default export */ __webpack_exports__["default"] = (router); // router.beforeEach((to, from, next) => {
...
/* harmony default export */ __webpack_exports__["default"] = (new vuex__WEBPACK_IMPORTED_MODULE_1__["default"].Store({
  ...
  mutations: {
    ...
    SESSION_CLEAR: function SESSION_CLEAR(state) {
      state.user = null;
      js_cookie__WEBPACK_IMPORTED_MODULE_3__["remove"]("accessToken");
      axios__WEBPACK_IMPORTED_MODULE_2___default.a.defaults.headers.common["Authorization"] = null;
      location.reload();
    }
  },
  actions: {
    register: function register(_ref, credentials) {
      ...
      axios__WEBPACK_IMPORTED_MODULE_2___default.a.post("auth/register", credentials).then(function (_ref2) {
        var data = _ref2.data;
    ...
    login: function login(_ref3, credentials) {
      ...
      axios__WEBPACK_IMPORTED_MODULE_2___default.a.post("auth/login", credentials).then(function (_ref4) {
        var data = _ref4.data;
        commit("SESSION_SET", data);
      })["catch"](function (err) {
        console.error(err);
    ...
    refresh: function refresh(_ref5) {
      var commit = _ref5.commit;
      axios__WEBPACK_IMPORTED_MODULE_2___default.a.get("auth/refresh", {
        headers: {
          Authorization: "Bearer ".concat(js_cookie__WEBPACK_IMPORTED_MODULE_3__["get"]("accessToken"))
        }
      }).then(function (_ref6) {
        var data = _ref6.data;
        commit("SESSION_SET", data);
...
__webpack_require__(/*! /Users/indicativa/Developer/laravueauth/resources/js/app.js */"./resources/js/app.js");
module.exports = __webpack_require__(/*! /Users/indicativa/Developer/laravueauth/resources/sass/app.scss */"./resources/sass/app.scss");
